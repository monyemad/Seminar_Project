    ...
    try {
      ...
      if (img != null) {
        ...
        final response = await dio.post(
            'https://c0e0-2c0f-fc89-ab-63f2-d723-d0ed-1278-5bb0.ngrok-free.app/match-face',
            data: formData);

        if (response.statusCode == 200) {
          setState(() {
            responseData = response.data.toString(); // Store the response data
          });
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Column(
                        children: [
                          ElevatedButton(onPressed: pickFromGallery,
                              child: const Text("Gallery")),
                          const SizedBox(
                            height: 10,
                          ),
                          ElevatedButton(onPressed: pickFromCamera,
                  ...
                  if (responseData != null) // Display the response data
                    Padding(
